...
> **CLOSED by AP1 (2026-06-06).** W3 shipped: reschedule + cancellation request modals
> (internal-staff dropdown with auto-approve; external Review-page entry to Pending) and the
> two supervisor approval pages over `getPending`, plus the wired dashboard tile. See
