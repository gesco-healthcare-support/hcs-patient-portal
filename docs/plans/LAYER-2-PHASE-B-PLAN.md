...
| **B-6** | **Test coverage 6% -> 60% overall, >= 80% new-code** | ongoing | **IN PROGRESS (Tiers 1+2+3 MERGED through 2026-04-27; coverage 35.2%; Wave-2 follow-up next for B-6 closure)** |

## Currently active

[LAYER-2-PHASE-B-6-PLAN.md](./LAYER-2-PHASE-B-6-PLAN.md) -- B-6 Tiers 1+2+3 MERGED; Wave-2 follow-up next for B-6 closure.
...
2026-04-27 -- B-6 Tier 3 MERGED (PR-3E #154 closed the set); Wave-2 follow-up is the next atomic unit. SonarCloud overall coverage 35.2%, below the 60% B-6 target.
