...
| 6 Dependencies           | **DEFERRED 2026-09-09** until coverage is raised | -- | 99 advisories live, not the 88 previously recorded. **27 sit on packages that ALREADY carry a `resolutions` pin**, and two of those pins are exact versions that are themselves vulnerable -- holding ten alerts open. Research recorded on #585. |
| 7 Rule families          | NOT STARTED                                                   | --                                                                                      | --                                                                                                                                                                                |
| 8 Coverage expansion     | **IN PROGRESS 2026-09-10** -- 8.1 settled, 8.1b planned | #777 `2abe0699` (on the epic, not yet cascaded to main) | **~44%**, roughly 14,800 uncovered (`main` @ `6caee3d1`). 8.1 settled the denominator: 1,300 Python lines stay IN because `tools/packet-templates` and `docker/packet-renderer` ship inside the production image (`Dockerfile:4`, `:60`). 8.1b is #784, #785, #786, #787, plus #807. The C# and Angular bulk is about 91% of what remains and is being decomposed now. |
...
| 6   | [Dependencies](06-dependencies.md)                          | **99 advisories**, 1 critical | Deferred until coverage rises |
| 7   | [Rule families](07-rule-families.md)                        | ~1,249 in 100 families               | Bulk. Largest families first; 72% sits in the top 15.                                                              |
| 8   | [Coverage expansion](08-coverage-expansion.md)              | **44.0%** (`main` @ `6caee3d1`, 2026-09-10) | 14,849 uncovered. Back end 56.2%, Angular 35.4%. Moves daily -- re-measure, do not cite |
