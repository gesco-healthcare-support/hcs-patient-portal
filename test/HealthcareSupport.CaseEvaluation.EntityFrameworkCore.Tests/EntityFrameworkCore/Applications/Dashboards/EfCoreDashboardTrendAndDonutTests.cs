...
/// <summary>
/// EF Core runner for <c>DashboardTrendAndDonutTests</c>. The test body lives in the
...
/// </summary>
public class EfCoreDashboardTrendAndDonutTests
    : DashboardTrendAndDonutTests<CaseEvaluationEntityFrameworkCoreTestModule>
{
}
