...
///
/// Per OLD spec (Phase 0.1, 2026-05-01) Doctor is a non-user reference entity (no login).
/// Test users cover the seven intended user-facing roles:
///
///   Host scope (TenantId = null):
///     - HostAdmin      (role: "admin")  -- dev/debug superuser with cross-tenant visibility
///
///   TenantA scope:
///     - TenantAdmin1   (role: "TenantAdmin")       -- per-tenant administrator
