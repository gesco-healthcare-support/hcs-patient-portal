...
@Component({
  selector: 'app-appointment-type-detail-modal',
...
export class AppointmentTypeDetailModalComponent {
  public readonly service = inject(AppointmentTypeDetailViewService);
}
