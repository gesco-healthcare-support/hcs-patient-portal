...
@Component({
  selector: 'app-defense-attorney-detail-modal',
  ...
  templateUrl: './defense-attorney-detail.component.html',
  styles: [],
})
export class DefenseAttorneyDetailModalComponent {
  public readonly service = inject(DefenseAttorneyDetailViewService);
}
