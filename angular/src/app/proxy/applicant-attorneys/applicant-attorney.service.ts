import type { ApplicantAttorneyCreateDto, ApplicantAttorneyDto, ApplicantAttorneyUpdateDto, ApplicantAttorneyWithNavigationPropertiesDto, GetApplicantAttorneysInput } from './models';
