    ...
    this.restService.request<any, PagedResultDto<DoctorAvailabilityWithNavigationPropertiesDto>>(
      {
        ...
        params: {
          ...
          availableDateMax: input.availableDateMax,
          fromTimeMin: input.fromTimeMin,
          fromTimeMax: input.fromTimeMax,
          toTimeMin: input.toTimeMin,
          toTimeMax: input.toTimeMax,
