...
export class PatientService {
  ...
  getOrCreatePatientForAppointmentBooking = (input: CreatePatientForAppointmentBookingInput, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PatientWithNavigationPropertiesDto>({
      method: 'POST',
  ...
  getPatientByEmailForAppointmentBooking = (email: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PatientWithNavigationPropertiesDto>({
      method: 'GET',
  ...
  getPatientForAppointmentBooking = (id: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PatientWithNavigationPropertiesDto>({
      method: 'GET',
      url: `/api/app/patients/for-appointment-booking/${id}`,
    },
    { apiName: this.apiName,...config });
  ...
  updateMyProfile = (input: PatientUpdateDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PatientDto>({
      method: 'PUT',
      url: '/api/app/patients/me',
      body: input,
  ...
  updatePatientForAppointmentBooking = (id: string, input: PatientUpdateDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PatientDto>({
      method: 'PUT',
      url: `/api/app/patients/for-appointment-booking/${id}`,
      body: input,
