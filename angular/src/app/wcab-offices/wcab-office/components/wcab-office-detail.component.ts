...
@Component({
  selector: 'app-wcab-office-detail-modal',
  ...
  templateUrl: './wcab-office-detail.component.html',
  styles: [],
})
export class WcabOfficeDetailModalComponent {
  public readonly service = inject(WcabOfficeDetailViewService);
}
