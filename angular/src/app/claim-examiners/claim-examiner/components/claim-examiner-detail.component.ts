...
@Component({
  selector: 'app-claim-examiner-detail-modal',
  ...
  templateUrl: './claim-examiner-detail.component.html',
  styles: [],
})
export class ClaimExaminerDetailModalComponent {
  public readonly service = inject(ClaimExaminerDetailViewService);
}
