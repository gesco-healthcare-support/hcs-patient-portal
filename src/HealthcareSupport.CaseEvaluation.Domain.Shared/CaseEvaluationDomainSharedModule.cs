...
public class CaseEvaluationDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CaseEvaluationDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<CaseEvaluationResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/CaseEvaluation");

            options.DefaultResourceType = typeof(CaseEvaluationResource);
        ...
        {
            options.MapCodeNamespace("CaseEvaluation", typeof(CaseEvaluationResource));
        });
    }
}
