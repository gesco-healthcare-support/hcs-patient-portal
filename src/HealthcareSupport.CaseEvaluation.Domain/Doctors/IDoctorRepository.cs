...
public interface IDoctorRepository : IRepository<Doctor, Guid>
{
    ...
    Task<long> GetCountAsync(string? filterText = null, string? firstName = null, string? lastName = null, string? email = null, Guid? appointmentTypeId = null, Guid? locationId = null, CancellationToken cancellationToken = default);
}