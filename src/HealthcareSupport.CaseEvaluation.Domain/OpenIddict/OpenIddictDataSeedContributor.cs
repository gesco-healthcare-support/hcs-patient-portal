...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["CaseEvaluation_App:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["CaseEvaluation_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["CaseEvaluation_Swagger:RootUrl"]?.TrimEnd('/');
