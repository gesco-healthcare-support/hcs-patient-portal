...
| `CaseTracker/IIntegrationOutboxRepository.cs` | Adds `TryLeaseAsync`, `CountSentSinceAsync` and `HasIntakeAsync`; the EF implementation lives in the EntityFrameworkCore layer. |
