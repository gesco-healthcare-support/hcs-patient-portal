...
````bash
Add-Migration Your_Migration_Name -Context CaseEvaluationDbContext
````

Using EF Core command line tool;

````bash
dotnet ef migrations add Your_Migration_Name --context CaseEvaluationDbContext
````
...
````bash
Add-Migration Your_Migration_Name -Context CaseEvaluationTenantDbContext -OutputDir TenantMigrations
````

Using EF Core command line tool:

````bash
dotnet ef migrations add Your_Migration_Name --context CaseEvaluationTenantDbContext --output-dir TenantMigrations
````
